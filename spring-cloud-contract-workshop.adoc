...
Write a new test (you can use the existing test class) in `customer` and use the new contract to trigger sending a message
...
and use SCC to test the `customer` consuming ``OrderPreparedEvent``s
